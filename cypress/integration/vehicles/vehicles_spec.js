...
describe('App E2E test', function () {
    ...
    describe('Vehicles', function () {
        ...
        describe('Vehicles basics + table', function () {


            it('should visit the page correctly', function () {
                cy.visit('#/home/vehicles')
                cy.url().should('eq', 'http://127.0.0.1:9000/#/home/vehicles')
            })
            ...
            it('should correctly show data on the tables', function () {
                cy.get('[data-test-id="vehicleTableDetails"]').then($el => {
        ...
        describe('Vehicles - search box', function () {
            ...
            it('should not show any info on typing impossible registration', function () {
                ...
                cy.wait(2500)
                cy.get('[data-test-id="vehicleTableDetailsHeader"]').then(element => {
                    console.log(element)
                    expect(element[0].children.length).to.equal(0)
                })
                //expect(cy.get('[data-test-id="vehicleTableDetails"]')).to.not.exist()
                /* cy.get('[data-test-id="vehicleTableDetails"]').then($el => {
            ...
            describe('zones', function () {
                ...
                // between 1 and 15 (25 being the default max it shows at once)
