...
describe('App E2E test', function () {
    ...
    describe('authorization', function () {
        ...
        describe('authorization basics + table', function () {


            it('should visit the page correctly', function () {
                cy.visit('#/home/authorization')
                cy.url().should('eq', 'http://127.0.0.1:9000/#/home/authorization')
            })
            ...
            it('should correctly show data on the tables', function () {
                cy.get('[data-test-id="authorizationTableDetails"]').then($el => {
