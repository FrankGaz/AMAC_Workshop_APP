...
describe('App E2E test', function () {
    ...
    describe('interventionKind', function () {

        describe('interventionKind basics + table', function () {


            it('should visit the page correctly', function () {
                cy.visit('#/home/intervention_kind')
                cy.url().should('eq', 'http://127.0.0.1:9000/#/home/intervention_kind')
            })
            ...
            it('should correctly show data on the tables', function () {
                cy.get('[data-test-id="interventionKindTableDetails"]').then($el => {
