...
describe('App E2E test', function () {
    ...
    describe('revision', function () {
        ...
        describe('revision basics + table', function () {


            it('should visit the page correctly', function () {
                cy.visit('#/home/revision')
                cy.url().should('eq', 'http://127.0.0.1:9000/#/home/revision')
            })
            ...
            it('should correctly show data on the tables', function () {
                cy.get('[data-test-id="revisionTableDetails"]').then($el => {
