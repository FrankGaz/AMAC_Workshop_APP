...
describe('App E2E test', function () {
    ...
    describe('management', function () {
        ...
        describe('management basics + table', function () {


            it('should visit the page correctly', function () {
                cy.visit('#/home/management')
                cy.url().should('eq', 'http://127.0.0.1:9000/#/home/management')
            })
            ...
            it('should correctly show data on the tables', function () {
                cy.get('[data-test-id="managementTableDetails"]').then($el => {
