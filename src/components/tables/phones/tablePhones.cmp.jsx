...
import TablePhonesModal from "./tablePhones.modal";

const TABLE_PHONES_FIELDS = ["phone_kind", "country_code", "number"];

const TablePhonesComponent = ({ phonesList, doAddPhone, doDeletePhone }) => {
  ...
  useEffect(() => {
    if (phonesList) {
      ...
      setTotalItems(phonesList.length);
    }
  }, [phonesList]);
          ...
          <div className="col-md-12 widget-container">
            ...
            >
              <div className="col-md-9">
                <h3>
                  <span className="blue">{t("phones")}</span>
                </h3>
              </div>
