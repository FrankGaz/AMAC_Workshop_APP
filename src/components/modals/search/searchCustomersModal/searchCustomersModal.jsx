...
import SearchModalCustomersSearchBox from './searchModalCustomersSearchBox'
import Pagination from '../../../reusableComponents/pagination'
import CloseButton from '../../../reusableComponents/CloseButton'
import logic from '../../../../logic/logic'
import customersApiService from './customersService'
import ReloadItems from '../../../reusableComponents/reloadItems'
import LoadingIcon from '../../../reusableComponents/loadingIcon';

const SearchCustomersModal = ({ closeModal, showModal, searchSelection }) => {
            ...
            <div className="modal-content">
                ...
                <div className="modal-header">
                    ...
                    <h3 className="smaller lighter blue no-margin">
                        {t('search')} {t('lowercase', { text: t('customer') })}
                    </h3>
                </div>
                ...
                <div className="modal-body">
                    ...
                    <div className="row">
                        ...
                        <SearchModalCustomersSearchBox requestSearch={handleRequestSearch}></SearchModalCustomersSearchBox>
                    </div>
                    ...
                    <div className="row table-responsive-row">
                        <div className="col-md-12 table-responsive table-search">
                            <table className="table table-hover-search table-striped">
                                ...
                                <tbody data-test-id='customerDetailsHeader'>
                                    {items && items.map(((item, index) =>
                                        <tr data-test-id='customerDetails' onClick={e => handleSelectItemClick(e, item)} key={index} ng-repeat="fleet in $data track by $index" className="pointer">
                                            <td data-test-id='customerDetails.name' data-sortable="'name'">
                                                {item.name}
                                            </td>
