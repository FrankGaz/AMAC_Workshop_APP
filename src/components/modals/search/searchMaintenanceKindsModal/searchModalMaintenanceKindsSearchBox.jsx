...
const SearchModalMaintenanceKindsSearchBox = props => {
    ...
    <div className="widget-box ui-sortable-handle collapsed">
      <div className="widget-header widget-header-large">
        <div className="col-gray-bg">
          <form name="forms.searchMaintenanceKindsModalForm" noValidate>
...
export default SearchModalMaintenanceKindsSearchBox
